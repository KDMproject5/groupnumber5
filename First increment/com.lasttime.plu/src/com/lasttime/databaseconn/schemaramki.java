...
public class schemaramki extends oracleramki{
	...
	public int registrationinsert(String fname,String username,String email_id,String userpassword,String confirm_password,String security_answer) throws Exception{
	
		PreparedStatement query = null;
Connection conn = null;
try{	
conn = oracleramkiConnection();
	query = conn.prepareStatement("insert into register (fname,username,email_id,userpassword, confirm_password,security_answer) VALUES ( ?,?,?, ?, ?, ? ) "); 
